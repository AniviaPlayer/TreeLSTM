...
MEM_DIM = 200
IN_DIM = 300
SENTENCE_FILE="data/sents.txt"
DESCRIPT_FILE="data/cparents.txt"
...
class Learner(object):
    ...
    def __init__(self,sentence_file,descript_file):
        ...
        self.num_training_samples = self.mgr.get_num_sample()
        self.rng = np.random.RandomState(123)
        self.treelstm = TreeLSTM(self.mgr,self.rng,MEM_DIM,IN_DIM)
        self.label_list = io.loadLabel()
